...
function viewUpdate () {
    ...
    const firstLine = document.createElement('div')
        firstLine.classList.add('line') // Дали класс дом елементу
       
        div.append(firstLine)   // Добавляем firstLine в div
        ...
        firstLine.append(
            done,  // Добавляем 'done' в фърст лайн
            ...string
    ...
    for (let i = 1; i < showedStrings.length; i++ ) {
        ...
        line.classList.add('line') // Дали класс дом елементу
        div.append(line)   // Добавляем line в div
